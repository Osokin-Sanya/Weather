...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener('input', () => {
        ...
        const showСities = arr.filter(elem => elem.toLowerCase().startsWith(x.toLowerCase()));
